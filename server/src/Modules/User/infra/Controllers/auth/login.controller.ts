...
import { UserAuthenticated } from 'src/Modules/User/domain/interfaces/login/UserAuthenticated.interface';
...
export class LoginController {
  ...
  async execute(@Body() loginDto: LoginDto): Promise<UserAuthenticated> {
